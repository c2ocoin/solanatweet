        ...
        <div class="px-8 py-4 border-l-4 border-pink-500">
            <div class="py-1">
                ...
                <time class="text-gray-500 text-sm" :title="tweet.created_at">
                    <router-link :to="{ name: 'Tweet', params: { tweet: tweet.publicKey.toBase58() } }"
            ...
            <!-- Content field. -->
            <textarea ref="textarea" rows="1" class="text-xl w-full focus:outline-none resize-none mb-3"
                placeholder="What's happening?" v-model="content"></textarea>
            ...
            <div class="flex flex-wrap items-center justify-between -m-2">
                ...
                <div class="relative m-2 mr-4">
                    <input type="text" placeholder="topic"
                        class="text-pink-500 rounded-full pl-10 pr-4 py-2 bg-gray-100" :value="slugTopic"
                        @input="topic = $event.target.value">
                    <div class="absolute left-0 inset-y-0 flex pl-3 pr-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 m-auto"
                            :class="slugTopic ? 'text-pink-500' : 'text-gray-400'" viewBox="0 0 20 20"
                            fill="currentColor">
                ...
                <div class="flex items-center space-x-4 m-2 ml-auto">
                    ...
                    <!-- Close button. -->
                    <button class="text-gray-500 px-4 py-2 rounded-full border bg-white hover:bg-gray-50"
                        @click="emit('close')">
                        Cancel
                    </button>
                    ...
                    <button class="text-white px-4 py-2 rounded-full font-semibold" :disabled="!canTweet"
                        :class="canTweet ? 'bg-pink-500' : 'bg-pink-300 cursor-not-allowed'" @click="update">
                        Update
                    </button>
                </div>
            </div>
